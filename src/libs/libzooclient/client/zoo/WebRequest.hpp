...
protected:
	...
	void startRequest(QUrl url, const QByteArray &out, qint64 to=Constants::OCTOMY_WEB_TIMEOUT);
	void startRequestPOST(QUrl url, const QByteArray &out, qint64 to=Constants::OCTOMY_WEB_TIMEOUT);
	void startRequest(QUrl url, bool onlyHead=false, qint64 to=Constants::OCTOMY_WEB_TIMEOUT);
