...
/*!
	...
	\sa Qt::Alignment
*/
void OctoStyle::drawItemText(QPainter *painter, const QRect &rect, int alignment, const QPalette &pal,
							 bool enabled, const QString& text, QPalette::ColorRole textRole) const
{
	if (text.isEmpty()) {
		return;
...
/*!
	\reimp
*/
void OctoStyle::drawPrimitive(PrimitiveElement elem,
							  ...
							  QPainter *painter, const QWidget *widget) const
{
	...
	case PE_FrameGroupBox: {
		QPixmap pixmap(QLatin1String(":/resources/groupbox.png"));
	...
	case PE_IndicatorArrowLeft: {
		...
		arrow = colorizedImage(QLatin1String(":/resources/arrow.png"), arrowColor, rotation);
		QRect rect = option->rect;
		QRect arrowRect;
	...
	case PE_IndicatorHeaderArrow:
		if (const QStyleOptionHeader *header = qstyleoption_cast<const QStyleOptionHeader *>(option)) {
			...
			if (header->sortIndicator & QStyleOptionHeader::SortUp) {
				arrow = colorizedImage(QLatin1String(":/resources/arrow.png"), arrowColor);
			} else if (header->sortIndicator & QStyleOptionHeader::SortDown) {
				arrow = colorizedImage(QLatin1String(":/resources/arrow.png"), arrowColor, 180);
			}
			if (!arrow.isNull()) {
	...
	case PE_FrameFocusRect:
		if (const QStyleOptionFocusRect *fropt = qstyleoption_cast<const QStyleOptionFocusRect *>(option)) {
			...
			painter->setBrush(gradient);
			painter->drawRoundedRect(option->rect.adjusted(0, 0, -1, -1), 6.0, 6.0);//LENNART 1,1
			painter->restore();
		}
		break;
	case PE_PanelButtonCommand: {
		...
		p->drawRoundedRect(r, 6.0, 6.0);//LENNART 2,2
		p->setBrush(Qt::NoBrush);

		// Outline
		p->setPen(!isEnabled ? QPen(darkOutline.lighter(115)) : QPen(darkOutline, 1));
		p->drawRoundedRect(r, 6.0, 6.0); //LENNART 1,1

		p->setPen(d->innerContrastLine());
		p->drawRoundedRect(r.adjusted(1, 1, -1, -1), 6.0, 6.0);//LENNART
...
/*!
  \reimp
*/
void OctoStyle::drawControl(ControlElement element, const QStyleOption *option, QPainter *painter,
...
/*!
  \reimp
*/
QPalette OctoStyle::standardPalette () const
{
...
/*!
  \reimp
*/
void OctoStyle::drawComplexControl(ComplexControl control, const QStyleOptionComplex *option,
								   QPainter *painter, const QWidget *widget) const
{
	QColor buttonColor = d->buttonColor(option->palette);
		...
		if (const QStyleOptionSpinBox *spinBox = qstyleoption_cast<const QStyleOptionSpinBox *>(option)) {
			...
			if (!QPixmapCache::find(pixmapName, cache)) {
				...
				if (spinBox->buttonSymbols == QAbstractSpinBox::PlusMinus) {
					...
					QPixmap upArrow = colorizedImage(QLatin1String(":/resources/arrow.png"),
					...
					QPixmap downArrow = colorizedImage(QLatin1String(":/resources/arrow.png"),
		...
		if (const QStyleOptionTitleBar *titleBar = qstyleoption_cast<const QStyleOptionTitleBar *>(option)) {
			...
			if (titleBar->subControls & SC_TitleBarShadeButton && (titleBar->titleBarFlags & Qt::WindowShadeButtonHint)) {
				...
				if (shadeButtonRect.isValid()) {
					...
					QPixmap arrow = colorizedImage(QLatin1String(":/resources/arrow.png"), textColor);
			...
			if (titleBar->subControls & SC_TitleBarUnshadeButton && (titleBar->titleBarFlags & Qt::WindowShadeButtonHint)) {
				...
				if (unshadeButtonRect.isValid()) {
					...
					QPixmap arrow = colorizedImage(QLatin1String(":/resources/arrow.png"), textColor, 180);
	...
	case CC_ScrollBar:
		...
		if (const QStyleOptionSlider *scrollBar = qstyleoption_cast<const QStyleOptionSlider *>(option)) {
			...
			if (scrollBar->subControls & SC_ScrollBarSubLine) {
				...
				QPixmap arrowPixmap = colorizedImage(QLatin1String(":/resources/arrow.png"), arrowColor, rotation);
		...
		if (const QStyleOptionComboBox *comboBox = qstyleoption_cast<const QStyleOptionComboBox *>(option)) {
			...
			if (!QPixmapCache::find(pixmapName, cache)) {
				...
				if (comboBox->subControls & SC_ComboBoxArrow) {
					...
					arrowColor.setAlpha(220);
					QPixmap downArrow = colorizedImage(QLatin1String(":/resources/arrow.png"), arrowColor, 180);
...
/*!
  \reimp
*/
int OctoStyle::pixelMetric(PixelMetric metric, const QStyleOption *option, const QWidget *widget) const
{
	switch (metric) {
...
/*!
  \reimp
*/
QSize OctoStyle::sizeFromContents(ContentsType type, const QStyleOption* option,
	...
	case CT_MenuItem:
		if (const QStyleOptionMenuItem *menuItem = qstyleoption_cast<const QStyleOptionMenuItem *>(option)) {
			...
			if (menuItem->text.contains(QLatin1Char('\t'))) {
				...
				w += 2 * OctoStylePrivate::menuArrowHMargin;
			...
			w += checkcol;
			w += int(OctoStylePrivate::menuRightBorder) + 10;
			newSize.setWidth(w);
			if (menuItem->menuItemType == QStyleOptionMenuItem::Separator) {
				if (!menuItem->text.isEmpty()) {
...
void OctoStyle::polish(QApplication* app)
{
	QCommonStyle::polish(app);
}

void OctoStyle::polish(QPalette& pal)
{
...
/*!
  \reimp
*/
void OctoStyle::polish(QWidget *widget)
{
...
void OctoStyle::unpolish(QApplication* app)
{
...
/*!
  \reimp
*/
void OctoStyle::unpolish(QWidget *widget)
{
...
/*!
  \reimp
*/
QRect OctoStyle::subControlRect(ComplexControl control, const QStyleOptionComplex *option,
...
/*!
  \reimp
*/
int OctoStyle::styleHint(StyleHint hint, const QStyleOption* option, const QWidget* widget,
...
/*! \reimp */
QRect OctoStyle::subElementRect(SubElement sr, const QStyleOption *opt, const QWidget *w) const
{
