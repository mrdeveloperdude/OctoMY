#include "MultiViewFilter.hpp"


MultiViewFilter::MultiViewFilter(QObject *parent)
...
bool MultiViewFilter::filterAcceptsRow(int source_row, const QModelIndex &source_parent) const
{
