...
public:
	...
	virtual bool Touches(Point* geom, const QSharedPointer<MapAdapter> mapadapter)=0;
	virtual void draw(QPainter* painter, const QSharedPointer<MapAdapter> mapadapter, const QRect &viewport, const QPoint offset)=0;
