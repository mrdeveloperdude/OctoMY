...
void CameraWidget::setCamera(const QCameraInfo &ci)
{
	OC_METHODGATE();
	//Free old camera
	{
...
void CameraWidget::showMessage(QString msg)
{
	OC_METHODGATE();
...
void CameraWidget::detectBarcodes(const QVideoFrame &frame)
{
	OC_METHODGATE();
...
void CameraWidget::onCameraDevicesChanged()
{
	OC_METHODGATE();
	/*
...
/*
QAudioEncoderSettings CameraWidget::getAudioSettings() const
{
	OC_METHODGATE();
...
/*
void CameraWidget::setAudioSettings(const QAudioEncoderSettings &audioSettings)
{
	OC_METHODGATE();
...
/*
QVideoEncoderSettings CameraWidget::getVideoSettings() const
{
	OC_METHODGATE();
...
/*
void CameraWidget::setVideoSettings(const QVideoEncoderSettings &videoSettings)
{
	OC_METHODGATE();
...
QString CameraWidget::format() const
{
	OC_METHODGATE();
	return boxValue(ui->containerFormatBox).toString();
}

void CameraWidget::setFormat(const QString &format)
{
...
/*
QImageEncoderSettings CameraWidget::getImageSettings() const
{
	OC_METHODGATE();
...
/*
void CameraWidget::setImageSettings(const QImageEncoderSettings &imageSettings)
{
	OC_METHODGATE();
...
QVariant CameraWidget::boxValue(const QComboBox *box) const
{
	OC_METHODGATE();
...
void CameraWidget::selectComboBoxItem(QComboBox *box, const QVariant &value)
{
	OC_METHODGATE();
...
void CameraWidget::on_toolButtonCaptureImage_clicked()
{
	OC_METHODGATE();
	captureImage();
}

void CameraWidget::on_toolButtonRecordVideo_toggled(bool checked)
{
	OC_METHODGATE();
	checked?record():stop();
}

void CameraWidget::on_toolButtonBack_clicked()
{
	OC_METHODGATE();
	/*
	{
...
void CameraWidget::on_toolButtonSettings_clicked()
{
	OC_METHODGATE();
	/*
	{
...
void CameraWidget::on_toolButtonFocus_clicked()
{
	OC_METHODGATE();
	tryFocus();
}
