#include "ActuatorManagementWidget.hpp"
...
ActuatorManagementWidget::ActuatorManagementWidget(QWidget *parent)
	: QWidget(parent)
...
ActuatorManagementWidget::~ActuatorManagementWidget()
{
	OC_METHODGATE();
	delete ui;
	ui=nullptr;
...
void ActuatorManagementWidget::updateWidgetCount(quint32 actualNum)
{
	OC_METHODGATE();
...
void ActuatorManagementWidget::configure(QSharedPointer<ControllerHandler> handler)
{
	OC_METHODGATE();
	if(mDebug){
...
void ActuatorManagementWidget::toggleLimpAll(){
	OC_METHODGATE();
	if(mDebug){
...
void ActuatorManagementWidget::toggleEnableAll(){
	OC_METHODGATE();
	if(mDebug){
