...
void LineString::draw(QPainter* painter, const QSharedPointer<MapAdapter> mapadapter, const QRect &screensize, const QPoint offset)
{
	if (!visible) {
		return;
	}
...
bool LineString::Touches(Point* geom, const QSharedPointer<MapAdapter> mapadapter)
{
	touchedPoints.clear();
...
bool LineString::Touches(Geometry* /*geom*/, const QSharedPointer<MapAdapter> /*mapadapter*/)
{
	touchedPoints.clear();
