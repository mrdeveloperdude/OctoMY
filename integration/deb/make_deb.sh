...
DEPS=""
DEPS+="libgstreamer0.10-0"
DEPS+=", libgstreamer1.0-0"
DEPS+=", libgstreamer-plugins-base0.10-0"
DEPS+=", libgstreamer-plugins-base1.0-0"
DEPS+=", libasound2"
DEPS+=", libwayland-egl1-mesa"
DEPS+=", libwayland-cursor0"
DEPS+=", libxcb-xkb1"
DEPS+=", libxcb-render-util0"
DEPS+=", libxcb-xinerama0"
DEPS+=", libxcb-randr0"
DEPS+=", libxcb-image0"
DEPS+=", libxcb-keysyms1"
DEPS+=", libxcb-icccm4"
DEPS+=", libpulse0"
DEPS+=", libharfbuzz0b"
DEPS+=", libpcre2-16-0"
DEPS+=", libdouble-conversion1v5"
DEPS+=", libgles2-mesa"
