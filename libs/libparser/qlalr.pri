...
#qlalr_parser_cpp.variable_out = SOURCES
...
qlalr_table_cpp.commands = @echo Pretending to create *_table.cpp
#qlalr_table_cpp.variable_out = SOURCES
...
qlalr_parser_hpp.commands = @echo Pretending to create *_parser.hpp
#qlalr_parser_hpp.variable_out = HEADERS
...
qlalr_table_p_h.commands = @echo Pretending to create *_table_p.h
#qlalr_table_p_h.variable_out = HEADERS
