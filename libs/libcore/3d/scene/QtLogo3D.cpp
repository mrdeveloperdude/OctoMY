...
void QtLogo3D::add(const QVector3D &v, const QVector3D &n)
{
...
void QtLogo3D::quad(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2, GLfloat x3, GLfloat y3, GLfloat x4, GLfloat y4)
{
...
void QtLogo3D::extrude(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2)
{
