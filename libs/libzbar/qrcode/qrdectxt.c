...
#include <string.h>
//#include <iconv.h>
//NOTE: We made our own iconv because while it is highly portable, it DIRECTLY
//      contradicts one of the main policies of the OctoMY projectt; namely that
//      OctoMY should really be trivial to build
//      (double click .pro file and pres play).
#include "QtIconv.h"
